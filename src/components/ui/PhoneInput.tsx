  ...
  return (
    <div className={className}>
      ...
      <input
        ...
        maxLength={13}
        className={cn(
          'mt-1 h-11 w-full rounded-md border border-[#E3E5F0] px-3 text-base text-slate-900 placeholder:text-slate-400 focus:border-[#7177EE] focus:outline-none focus:ring-2 focus:ring-[#E4E6FB] disabled:bg-slate-50',
        )}
      />
